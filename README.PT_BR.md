...
> **Documentação técnica**: [Índice](docs/README.md) | [Desenvolvimento](docs/DEVELOPMENT.md) | [Arquitetura](docs/ARCHITECTURE.md) | [API](docs/API.md) | [Operação](docs/OPERATIONS.md)
...
- **Node.js** 26.8.2 (gerenciado com nvm)
- **PostgreSQL** 14+
- Contas em:
