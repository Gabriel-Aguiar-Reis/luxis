...
switch (appConfigService.getNodeEnv()) {
  case 'development':
    AppDataSource = new DataSource({
      type: 'postgres',
      host: appConfigService.getDatabaseHost() || 'localhost',
      port: appConfigService.getDatabasePort() || 5432,
      username: appConfigService.getDatabaseUser() || 'postgres',
      password: appConfigService.getDatabasePassword() || 'postgres',
      database: appConfigService.getDatabaseName() || 'luxis_dev',
      ...commonConfig
    })
    break
